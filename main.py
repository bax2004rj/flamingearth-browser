...
class main():
    def __init__(self):
        ...
        self.closeTab = ttk.Button(self.addcloseframe,text="X") # Tab closer
        self.closeTab.pack(side="right")

        self.tabs = ttk.Notebook(self.app) # Create tabs
    ...
    def tabAdd(self,page = "http://www.google.com/"): # Create new tab in browserTab module
        ...
        browserTab.newTab(self.tabObjects[-1],self.tabVars[-1],page)
